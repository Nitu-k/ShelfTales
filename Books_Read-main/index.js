...
app.get("/",async (req,res)=>{
    ...
    res.render("index.ejs",{title:"Welcome to ShelfTales Book Showcase!", isbn:books.isbn, genre:books.genre, name:books.name, author:books.author, rating:books.rating, localISBN:books.localISBN});
});
